...
| Patterns | Implemented in source | Saved pattern selection, current selection state, duplication, deletion, groove template creation, Clave Mode creation, and Swing template creation have labels. |
...
- Duplicate, delete, groove template creation, Clave Mode mixer, Clave Mode template, and Swing template controls have explicit labels.
