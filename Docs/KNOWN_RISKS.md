...
| Audio interruptions and route changes | Playback can stop or restart unexpectedly during calls, Siri, or output changes | The AV engine observes interruptions and route changes, but physical-device validation is still required. |
